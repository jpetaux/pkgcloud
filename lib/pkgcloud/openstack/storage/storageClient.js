...
const CONTAINER_META_PREFIX = 'x-container-';
const CONTAINER_REMOVE_META_PREFIX = 'x-remove-container-';
const OBJECT_META_PREFIX = 'x-object-';
const OBJECT_REMOVE_META_PREFIX = 'x-object-remove-';
